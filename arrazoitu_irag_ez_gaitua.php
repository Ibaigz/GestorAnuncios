...
<head>
    ...
    <title>Iragarkia ez gaitua</title>
                    ...
                    if ($stmt->rowCount() > 0) {
                        ...
                        <?php
                            if (isset($_COOKIE["dark"])) {
                                if ($_COOKIE["dark"] == "on") {
                                    ?>
                                    <h3 class="text-white">Arrazoitu "<a href="iragarkiaAdmin.php?id=<?php echo $iragarkia["id_iragarkia"] ?>"  class="linkIragarkia text-white"><?php echo $iragarkia["izena"] ?></a>" izeneko iragarkia ez gaitzea:</h3>
                                    <form action="email.php?id=7" method="post" class="formAdmin formAdminDivOscuro" onsubmit="validaCheckBox()">
                                    <?php
                                } else {
                                    ?>
                                    <h3>Arrazoitu "<a href="iragarkiaAdmin.php?id=<?php echo $iragarkia["id_iragarkia"] ?>"  class="linkIragarkia"><?php echo $iragarkia["izena"] ?></a>" izeneko iragarkia ez gaitzea:</h3>
                                    <form action="email.php?id=7" method="post" class="formAdmin" onsubmit="validaCheckBox()">
                                    <?php
                                }
                            } else {
                                ?>
                        ...
                        if (isset($_COOKIE["dark"])) {
                            if ($_COOKIE["dark"] == "on") {
                                ?>
                                <p class="text-white">Iragarkia ez da existitzen</p>
                                <?php
                            } else {
                                ?>
                                <p>Iragarkia ez da existitzen</p>
                                <?php
                            }
                        } else {
                            ?>
