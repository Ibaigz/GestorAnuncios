...
<head>
    ...
    <title>Gehitu Administratzaile bahiemena</title>
                        ...
                        if ($erab["egiaztatua"] == 1) {
                            if ($erab["rol"] != 0) {
                                if (isset($_COOKIE["dark"])) {
                                    if ($_COOKIE["dark"] == "on") {
                                        ?>
                                        <h3 class="text-white">Ziur zaude "<a href="perfilaAdmin.php?id=<?php echo $erab["id_erabiltzailea"] ?>" class="linkIragarkia text-white"><?php echo $erab["erabiltzailea"] ?></a>" izena duen erabiltzaileari administratzaile bahimenak eman nahi dizkiozula?</h3>
                                        <?php
                                    } else {
                                        ?>
                                        <h3>Ziur zaude "<a href="perfilaAdmin.php?id=<?php echo $erab["id_erabiltzailea"] ?>" class="linkIragarkia"><?php echo $erab["erabiltzailea"] ?></a>" izena duen erabiltzaileari administratzaile bahimenak eman nahi dizkiozula?</h3>
                                        <?php
                                    }
                                } else {
                                    ?>
                                ...
                                <?php
                                if (isset($_POST["bai"])) {
                                    header("Location: gehituPermisoAdmin.php?id=" . $id);
                                }

                                if (isset($_POST["ez"])) {
                                    header("Location: adminpage.php?id=1");
                                }
                                ...
                                <?php
                                echo "Erabiltzaile honek administratzaile behimena dauka jada";
                            }
                        } else {
                            ?>
                            <button onclick="goBack()" class="atzeraBotoia">&#8249;</button><br>
