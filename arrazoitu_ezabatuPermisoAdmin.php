...
<head>
    ...
    <title>Administratzaile baimenak kendu</title>
...
?>
    <div class="margin">
                ...
                if ($id == null) {
                    ...
                    if ($stmt->rowCount() > 0) {
                            ...
                            if ($erab["rol"] == 0) {
                                if ($erab["id_erabiltzailea"] == $erabiltzailea["id_erabiltzailea"]) {
                                    ...
                                    if (isset($_COOKIE["dark"])) {
                                        if ($_COOKIE["dark"] == "on") {
                                            ?>
                                            <p class="text-white">Ezin duzu zure administratzaile baimenak kendu</p>
                                            <?php
                                        } else {
                                            ?>
                                            <p>Ezin duzu zure administratzaile baimenak kendu</p>
                                            <?php
                                        }
                                    } else {
                                        ?>
                                    ...
                                    if (isset($_COOKIE["dark"])) {
                                        if ($_COOKIE["dark"] == "on") {
                                            ?>
                                            <h3 class="text-white">Arrazoitu "<a href="perfilaAdmin.php?id=<?php echo $erab["id_erabiltzailea"] ?>"  class="linkIragarkia text-white"><?php echo $erab["erabiltzailea"] ?></a>" erabiltzailearen administratzaile behimena kentzea:</h3>
                                            <?php
                                        } else {
                                            ?>
                                            <h3>Arrazoitu "<a href="perfilaAdmin.php?id=<?php echo $erab["id_erabiltzailea"] ?>"  class="linkIragarkia"><?php echo $erab["erabiltzailea"] ?></a>" erabiltzailearen administratzaile behimena kentzea:</h3>
                                            <?php
                                        }
                                    } else {
                                        ?>
                                    ...
                                    ?>
                                    <form action="email.php?id=1" method="post">
                                        <?php
                                            if (isset($_COOKIE["dark"])) {
                                                if ($_COOKIE["dark"] == "on") {
                                                    ?>
                                ...
                                if (isset($_COOKIE["dark"])) {
                                    if ($_COOKIE["dark"] == "on") {
                                        ?>
                                        <p class="text-white">Erabiltzailea ez da administratzailea</p>
                                        <?php
                                    } else {
                                        ?>
                                        <p>Erabiltzailea ez da administratzailea</p>
                                        <?php
                                    }
                                } else {
                                    ?>
                        ...
                        if (isset($_COOKIE["dark"])) {
                            if ($_COOKIE["dark"] == "on") {
                                ?>
                                <p class="text-white">Erabiltzailea ez da existitzen</p>
                                <?php
                            } else {
                                ?>
        ...
        ?>
        <script>
            window.addEventListener("load", inicioAdminKendu, false);

            function inicioAdminKendu() {
                let botoia = document.getElementById("bidali");
                botoia.addEventListener("click", validatuAdminKendu, false);
            }

            function validatuAdminKendu(e) {
                let mesua = document.getElementById("mesua").value;
                let spanMesua = document.getElementById("mezuaErrorea");
                if (validaText(mesua, spanMesua) && confirm("Ziur zaude erabiltzaileari aministratzaile bahimenak kendu nahi dizkiozula?")) {
                    // Bidalita
                } else {
                    e.preventDefault();
                }
